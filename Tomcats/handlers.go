...
func routes(store *Store, mailer *Mailer, authURL, wireAddr, staticDir, merchantsURL, floatPwd string) http.Handler {
	mux := http.NewServeMux()
	addWebRoutes(mux, authURL, wireAddr, staticDir, floatPwd, store, mailer)
