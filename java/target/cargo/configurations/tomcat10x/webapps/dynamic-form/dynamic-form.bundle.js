...
createApp({
  ...
  template: `
        <div class="form-container" :id="containerId">
          <h1>{{ schema?.title || 'Dynamic form' }}</h1>
          <p class="meta">
            <strong>Lu\u1ED3ng:</strong> \u0111\u1ECBnh ngh\u0129a form (JSON \u1EDF demo; XML c\xF3 th\u1EC3 parse server-side th\xE0nh c\xF9ng manifest)
            \u2192 <code>FormManifestServlet</code> (<code>{{ manifestUrl }}</code>) m\xF4 t\u1EA3 <em>form container</em> + slots;
            t\u1EEBng <code>attachments[].optionsUrl</code> g\u1ECDi <code>FormCodegenServlet</code> (codegen) \u2192 <code>defineComponent</code> g\u1EAFn v\xE0o slot;
            submit qua <code>{{ submitUrl }}</code>. M\u1ECDi URL \u0111\u1EC1u qua <code>/httpproxy</code> \u2014 c\u1EA7n <code>HTTP_PROXY_TARGET_BASE</code>.
            UI: m\u1ED9t file <code>dynamic-form.bundle.js</code> (esbuild, Vue external).
          </p>
          ...
          <template v-else>
            ...
            <form @submit.prevent="handleSubmit">
              ...
              <button type="submit">G\u1EEDi (POST JSON)</button>
            </form>
